...
<body>
    ...
    <div class="page-wrapper">
                ...
                <div class="row">
                    <div class="col col-md-7">
                        <div class="project-single-img">
                            <img src="assets/images/project-single/project-single-img.jpg" alt>
                        </div>
                    </div>
        ...
        <!-- section project-single-wrok-process -->
        <section class="project-single-wrok-process">
            <div class="grids">
                <div class="grid">
                    ...
                    <div class="details">
                        <h3>Challenge</h3>
                        <p>mnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo</p>
