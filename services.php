                    ...
                    <div class="col col-xs-12">
                        ...
                        <?php
                            ...
                            <div class="grid">
                                ...
                                <img class="card-img-top" src="backend/upload/<?php echo $row["img"]; ?>" alt="" style="width: 90%; height: 60%;">
                                    <div class="overlay">
                                        <a href="product_details.php"><i class="fa fa-link"></i></a>
                                    </div>
                                </div>
                                <div class="details">
                                    <h3><h4>Product Title :</h4><?php echo $row['title']; ?></h3>
                                    <p><h4>Product Description :</h4><?php echo $row['description']; ?></p>
                                    <div class="read-more">
                                        <a href="product_details.php?id=<?php echo $row['p_id'] ?>">Product Details</a>
                                    </div>
                                </div>
                            </div>
                            <?php }  } ?>
