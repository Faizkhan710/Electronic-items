                ...
                <div class="tm-bg-primary-dark tm-block tm-block-products">
                    <div class="tm-product-table-container">
                        <table class="table table-hover tm-table-small tm-product-table">
                            ...
                            <?php
              include("config.php");
              $query = "SELECT * FROM  `testing` inner join `cpri` on testing.t_id = cpri.t_id";
              ...
              ?>
                ...
                ?>
                   ...
                   if ($r == '0'){
                    ...
                    <button  style="width: 90px; height: 35px;border-radius: 20px;border: none;background-color:white;"><a style="color: black;"  href="lounched.php?id=<?php echo $row['c_id']; ?>" ><i class="fas fa-cog">EPRI</i></a></button>
