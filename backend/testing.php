            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 tm-block-col">
              ...
              ?>
                ...
                ?>
                   ...
                   $r = $row['result'];
                   if ($r == '0'){
                     echo "<center><h5>Failed!</h5></center>";
                   
                 }else{ ?>


                 <button  style="width: 90px; height: 35px;border-radius: 20px;border: none;background-color:white;"><a style="color: black;"  href="epri.php?id=<?php echo $row['t_id']; ?>" ><i class="fas fa-cog">EPRI</i></a></button>
