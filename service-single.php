                        ...
                        <?php
                            ...
                            <div class="grid">
                                ...
                                <h3><h4>Title : </h4><?php echo $row['title']; ?></h3>
                                    <h3><h4>Tester Name</h4><?php echo $row['tester_name']; ?></h3>
                                    <p><h4>Type of testing :</h4><?php echo $row['testing']; ?></p>
                                    <p><h4>Reamrks</h4><?php echo $row['remarks']; ?></p>
                                    <p><h4>Result :</h4><?php 
